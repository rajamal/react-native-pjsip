 ...
 * element.
 */
@interface RTCSIPVideoView : RCTView

// @property pjsua_vid_win_id vidWinId;

@end

@implementation RTCSIPVideoView {
...
-(UIView *)view {
    return [[RTCSIPVideoView alloc] init];
}
...
RCT_CUSTOM_VIEW_PROPERTY(windowId, NSNumber, RTCSIPVideoView) {
